...
| [docs/wide-layout.md](docs/wide-layout.md) | витрина во всю ширину страницы: как включить, что меняется, замеры на шести разрешениях |
...
**Ширина страницы — настройка витрины.** Самообслуживание GLPI держит
содержимое в 1320 точках; включите «Во всю ширину страницы», и витрина займёт
весь экран: четыре карточки в ряду на 1600, пять на 1920, шесть на 2560.
Длинный текст остаётся в читаемой строке, корзина не растягивается, на
планшете и телефоне вид не меняется. Подробно, со снимками «до и после» и
замерами — в [docs/wide-layout.md](docs/wide-layout.md).

![Витрина во всю ширину](docs/img/wide-layout.png)
...
2. Выполнить миграцию — теми же двумя командами:
...
классы: страницы магазина отдают ошибку. Это штатное поведение GLPI —
достаточно выполнить обе команды.

Если после обновления в форме витрины нет новых полей — например
«Во всю ширину страницы», — GLPI отдаёт форму из кеша скомпилированных
шаблонов. С версии 1.0.0-rc8 плагин сбрасывает этот кеш сам — при миграции и
при каждом включении, поэтому достаточно выключить и включить плагин.
Обновляясь с более ранних версий, сбросьте кеш вручную:
